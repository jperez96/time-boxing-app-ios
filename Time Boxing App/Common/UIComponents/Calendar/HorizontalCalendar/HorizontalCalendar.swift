...
public class HorizontalCalendar: UIView {
    ...
    private lazy var weekDays: UIView = { [unowned self] in
        ...
        stackView.addArrangedSubview(WeekDayLabel(with: "D", isDark: false))
        stackView.addArrangedSubview(WeekDayLabel(with: "L"))
        stackView.addArrangedSubview(WeekDayLabel(with: "M"))
        stackView.addArrangedSubview(WeekDayLabel(with: "M"))
        stackView.addArrangedSubview(WeekDayLabel(with: "J"))
        stackView.addArrangedSubview(WeekDayLabel(with: "V"))
